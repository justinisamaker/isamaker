    ...
    <section className="mt-14 md:mt-2 mb-12">
      <div className="prose w-full max-w-none">
        ...
        <p>
          ...
          maker culture, so I naturally gravitate toward projects where
        ...
        <p>
          ...
          equally comfortable jumping into PHP, Python, or proof-of-concept
          prototypes when a project needs momentum. I like solving problems with
        ...
        <p>
          ...
          ecosystem. We use tools like Kontent.ai, React, Tailwind, and Sitecore
          to build fast, flexible experiences that empower both users and
          content editors.
        </p>
        ...
        <p>
          ...
          users outside of a screen, but I'm also happy to work on more
